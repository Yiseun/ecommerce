...
public class CreateInitOrderRequest {
    private final String memberId;
    private final CreateInitOrderRequestBody body;
    ...
    public static CreateInitOrderRequest of(final String memberId, final CreateInitOrderRequestBody body){
        return new CreateInitOrderRequest(memberId,body);
    }
}
